      ...
      <div className="cart-container">
        ...
        {cartItems.length < 1 && (
          <div className="empty-cart">
            <h1>
              empty <i className="ri-shopping-cart-line"></i>
            </h1>
          </div>
        )}
            ...
            cartItems.map((item) => (
              ...
              <div className="cart-item" key={item._id}>
                ...
                <div className="cart-item-img-wrapper">
                  <Link to={`/items/store/${item.slug.current}`}>
                    <img
                ...
                <div className="cart-item-desc-wrapper">
                  ...
                  <div className="item-quant-and-remove">
                    ...
                    <div className="select-quantity">
                      <button
                        className="quant-min cart-quant"
                        onClick={() => {
                      ...
                      <div className="quant-val cart-quant">
                        {item.quantity}
                      </div>
                      <button
                        className="quant-max cart-quant"
                        onClick={() => {
        ...
        <div className="cart-items-price-wrapper">
          ...
          <div className="sub-total lkr">
            <div className="sub-total-header">Subtotal [LKR]</div>
            <div className="sub-total-price">{`LKR${totalPrice}.00`}</div>
          </div>
          {/* btns */}
          <div className="cart-btns">
            <Payment className="cart-btn" button_name={"CONTINUE PAYMENT"} />
            <Link to={"/store/crochets"}>
              <button className="btn-buy-white cart-btn">
                CONTINUE SHOPPING
              </button>
            </Link>
          </div>
